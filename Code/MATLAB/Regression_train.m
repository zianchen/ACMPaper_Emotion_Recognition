...
[valence,arousal,len,t1,t2,t3] = Getdata();
fid = fopen('C:\Users\sliu5\Desktop\first\valence.txt','w');
fid2 = fopen('C:\Users\sliu5\Desktop\first\arousal.txt','w');
path = 'C:\Users\sliu5\Desktop\first\re\';
for i=1:len
%modify file name    
